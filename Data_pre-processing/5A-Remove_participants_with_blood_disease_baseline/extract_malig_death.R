...
mydata <- readRDS("/rds/general/user/iw413/home/Summerproject/extraction_and_recoding/output_hes_malig.rds")
...
saveRDS(data.frame(mydata), paste0("/rds/general/user/iw413/home/Summerproject/extraction_and_recoding/output_registries_malig.rds"))
