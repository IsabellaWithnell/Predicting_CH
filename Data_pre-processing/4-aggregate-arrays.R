...
setwd("/rds/general/user/iw413/home/Summerproject")

   
# Loading outputs from previous steps
mydata <- readRDS("outputs/ukb_recoded.rds")
choices <- read.xlsx("extraction_and_recoding/parameters/parametersnewnew.xlsx")
...
var_names<-readRDS("outputs/ukb_recoded.rds")


saveRDS(var_names, "outputs/ukb_recoded.rds")
