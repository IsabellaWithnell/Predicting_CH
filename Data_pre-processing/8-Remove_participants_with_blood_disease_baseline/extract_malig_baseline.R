...
# Reading arguments mentioned in the sh file
...
mydata <- readRDS("/rds/general/user/iw413/home/Summerproject/extraction_and_recoding/output_registries_malig.rds")
...
if (length(mylist_codes) > 0) {
  # Reading codes create empty code
  field_ids <- NULL
  
  #Iterate through each text file with codes
...
saveRDS(data.frame(mydata), paste0("/rds/general/user/iw413/home/Summerproject/extraction_and_recoding/output_final_malig.rds"))
